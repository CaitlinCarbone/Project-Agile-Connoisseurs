...
const exportedMethods = {
    createTask(taskName, taskDescription, taskType, taskStatus, taskBudget, taskStartDate, taskEndDate) {
        taskName = validation.checkString(taskName, "Task Name");
        taskDescription = validation.checkString(taskDescription, "Task Description");
